...
export default function BannerUploadEditButton<TFieldValues extends FieldValues, TName extends Path<TFieldValues>>({
    field,
    previewUrl
}: THFFieldProps<TFieldValues, TName>) {
    const [preview, setPreview] = useState<string | null | undefined>(previewUrl);
    ...
    return (
        <div className="flex items-center justify-center">
            ...
            <div className="relative inline-block w-full">
                <div className="w-full h-32 rounded-sm bg-linear-to-br from-muted to-muted/50 border-2 border-border flex items-center justify-center overflow-hidden">
                    {preview ? (
                        <Image
                            src={preview}
                            alt="Avatar"
